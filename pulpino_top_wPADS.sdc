...
#  Created by Genus(TM) Synthesis Solution 16.12-s027_1 on Mon May 12 12:06:06 +0200 2025
...
current_design pulpino_top_wPADS

create_clock -name "clk" -add -period 5.0 -waveform {0.0 2.5} [get_ports clkp]
set_clock_transition -max 0.1 [get_clocks clk]
create_clock -name "spi_clk" -add -period 100.0 -waveform {0.0 50.0} [get_ports spi_clk]
set_clock_transition -max 0.5 [get_clocks spi_clk]
create_clock -name "jtag_clk" -add -period 100.0 -waveform {0.0 50.0} [get_ports jtag_clk]
set_clock_transition -max 0.5 [get_clocks jtag_clk]
...
set_false_path -from [get_clocks spi_clk] -to [get_clocks jtag_clk]
set_false_path -from [get_clocks jtag_clk] -to [get_clocks clk]
set_false_path -from [get_clocks jtag_clk] -to [get_clocks spi_clk]
set_clock_groups -asynchronous -group [get_clocks clk] -group [get_clocks spi_clk] -group [get_clocks jtag_clk]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports rst_np]
set_input_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports fetch_enable_ip]
set_input_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_rxp]
set_input_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_ctsp]
set_input_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_dsrp]
set_output_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_txp]
set_output_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_rtsp]
set_output_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports uart_dtrp]
set_output_delay -clock [get_clocks clk] -add_delay 0.025 [get_ports gpiop]
set_input_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_cs_ip]
set_input_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdi0_ip]
set_input_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdi1_ip]
set_input_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdi2_ip]
set_input_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdi3_ip]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdo0_op]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdo1_op]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdo2_op]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports spi_sdo3_op]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports {spi_mode_op[1]}]
set_output_delay -clock [get_clocks spi_clk] -add_delay 0.5 [get_ports {spi_mode_op[0]}]
set_input_delay -clock [get_clocks jtag_clk] -add_delay 0.5 [get_ports trstn_ip]
set_input_delay -clock [get_clocks jtag_clk] -add_delay 0.5 [get_ports tms_ip]
set_input_delay -clock [get_clocks jtag_clk] -add_delay 0.5 [get_ports tdi_ip]
set_output_delay -clock [get_clocks jtag_clk] -add_delay 0.5 [get_ports tdo_op]
...
set_clock_latency -source -max 0.25 [get_clocks clk]
set_clock_uncertainty -setup 0.25 [get_clocks clk]
set_clock_uncertainty -hold 0.25 [get_clocks clk]
set_clock_latency -max 5.0 [get_ports spi_clk]
set_clock_latency -source -max 5.0 [get_ports spi_clk]
set_clock_uncertainty -setup 5.0 [get_ports spi_clk]
set_clock_uncertainty -hold 5.0 [get_ports spi_clk]
set_clock_latency -max 5.0 [get_ports jtag_clk]
set_clock_latency -source -max 5.0 [get_ports jtag_clk]
set_clock_uncertainty -setup 5.0 [get_ports jtag_clk]
set_clock_uncertainty -hold 5.0 [get_ports jtag_clk]
